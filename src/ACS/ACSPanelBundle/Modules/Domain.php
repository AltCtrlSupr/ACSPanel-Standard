...
class Domain
{
    ...
    **/
    ...
    {
        $etld_file = TMP_PATH.EFFECTIVE_TLD_FILENAME;
        if (!file_exists($etld_file))
        {
            $ch = curl_init(EFFECTIVE_TLD_LIST);
            $fp = fopen($etld_file, 'w');
    ...
    **/
    ...
    {
        return substr($this->get_components(2, TRUE),0,-1);
    }
